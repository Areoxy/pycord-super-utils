...
class MySpamDetector(pycordSuperUtils.SpamDetectionGenerator):
...
AntiSpam = pycordSuperUtils.SpamManager(bot)
# Incase you want to use the default spam detector, don't pass a spam detector.
AntiSpam.add_punishments([pycordSuperUtils.Punishment(KickManager, punish_after=3)])
