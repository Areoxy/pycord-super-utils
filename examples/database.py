...
async def database_test():
    mongo_database = pycordSuperUtils.DatabaseManager.connect(
    ...
    postgre_database = pycordSuperUtils.DatabaseManager.connect(
    ...
    mysql_database = await pycordSuperUtils.create_mysql(
        host=..., port=..., user=..., password=..., dbname=...
    )
    # Replace '...' with the arguments.
    # create_mysql supports mysql AND mariaDB

    sqlite_database = pycordSuperUtils.DatabaseManager.connect(
