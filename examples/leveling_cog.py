...
class Leveling(commands.Cog, pycordSuperUtils.CogManager.Cog):
    def __init__(self, bot):
        self.bot = bot

        self.LevelingManager = pycordSuperUtils.LevelingManager(bot, award_role=True)
    ...
    @pycordSuperUtils.CogManager.event(pycordSuperUtils.LevelingManager)
